...
public class Edit_TIN extends WebDriverUtility {
	...
	@FindBy(xpath = "//section[@id='wrapper']/descendant::ng-autocomplete[@ng-reflect-placeholder='Tin Group Name']/descendant::input[@type='text']")private WebElement tinGrpName;
	@FindBy(xpath = "//button[normalize-space()='SEARCH']")private WebElement searchBtn;
	@FindBy(xpath = "//section[@id='wrapper']/descendant::div[text()='Danvale3']/following-sibling::div[@class='d-flex flex-row ng-star-inserted']/descendant::div[text()=' Edit ']")private WebElement edit;
