...
public class ManageTinLocationPage extends WebDriverUtility {
	...
	@FindBy(xpath = "//aside//span[text()='Manage TIN/Locations']")private WebElement ManageTinLocation;
	@FindBy(xpath="//div[text()='ADD TIN/GROUP ']")private WebElement addTinGroup;
	
	@FindBy(xpath = "//ngb-accordion//div[text()='TIN Information']")private WebElement tinInfo;
	...
	@FindBy(xpath = "//app-tin-item//div[text()='ADD LOCATION ']")private WebElement addLocation;
	@FindBy(xpath = "//div[text()='Practice Information']")private WebElement practiceInfo;
	...
	@FindBy(xpath = "//section[@id='wrapper']/descendant::ng-select[@ng-reflect-name='tin_id']/descendant::div[@role='combobox']/input[@type='text']")private WebElement drpdownNew;
