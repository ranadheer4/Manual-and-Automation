...
public class ViewGeneratedForms extends WebDriverUtility
{
	...
	@FindBy(xpath = "//section[@id='wrapper']/descendant::span[text()='Feb 20,2023 10:18 AM']/ancestor::div[@class='datatable-row-center datatable-row-group ng-star-inserted']/descendant::datatable-body-cell/div/div/span/i[@class='far fa-file-pdf fa-lg']")private WebElement pdf;
