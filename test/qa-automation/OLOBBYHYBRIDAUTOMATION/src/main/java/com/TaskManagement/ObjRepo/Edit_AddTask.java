...
@FindBy(xpath = "//input[@class='form-control form-control1 nobordershadow inputwithcalendar ng-dirty ng-invalid ng-touched']")private WebElement startDate;
@FindBy(xpath = "//body/ngb-modal-window[@role='dialog']/div[@role='document']/div/app-project-details/div/div/form[1]")private WebElement dueDate;
...
@FindBy(xpath = "//div[@class='modal-content cursor-draggable']/descendant::ng-select[@bindlabel='Name' and @formcontrolname='status']/descendant::div[@role='combobox']/input[@type='text']")private WebElement status;
@FindBy(xpath = "//div[@class='modal-content cursor-draggable']/descendant::ng-select[@bindlabel='Key' and @formcontrolname='priority']/descendant::div[@role='combobox']/input[@type='text']")private WebElement priority;
