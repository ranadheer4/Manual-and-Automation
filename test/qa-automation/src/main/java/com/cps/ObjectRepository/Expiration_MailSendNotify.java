...
public class Expiration_MailSendNotify extends WebDriverUtility{
	 ...
	 @FindBy(xpath = "//datatable-body[@role='rowgroup']/descendant::datatable-scroller[@class='datatable-scroll ng-star-inserted']/descendant::span[text()=' 03/17/2023 ']/../../../descendant::span[text()='Ashlyn Tyson 02/24/2023, 05:53:29 PM ']/../../../descendant::datatable-body-cell/div/span/i[@class='far fa-envelope fa-2x']")private WebElement SendMail;
